	...
	<div class="container">
		...
		<div class="row justify-content-center pt-5">
			...
			<div class="col-lg-4 col-md-6"> 
				...
				<h3 class="text-center pb-3" style=" font-size: 32px;">Add new User</h3>
				...
				<form action="" method="POST"  style="border-top: 4px solid black; border-left:4px solid black; padding: 15px; padding-bottom: 0px;">
					...
					<div class="mb-3">
					  ...
					  <input type="password" class="form-control" name="userpassword" required autocomplete="off">
			        </div>


                    <div class="text-center">
              			<button type="submit" class="btn btn-dark w-50" name="ucreatebtn">Create</button>
      			    </div>
      			       			    <p class="text-left pt-2"><a href="users-display.php" class="text-success" style="font-size:17px">Back to list</a></p>
				</form>
				<?php
